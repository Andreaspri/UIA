...
public:
    ...
    /// the time it is generated until the next_element time the base level image is
...
///
///     // update the texture
///     sf::Uint8* pixels = ...; // get a fresh chunk of pixels (the next_element frame of a movie, for example)
